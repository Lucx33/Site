...
fetch("http://localhost:3000/restaurantes",).then((response) => response.json()).then((data) => {
    document.getElementById("nome").innerHTML += (data[17].nome)
    document.getElementById("horarios").innerHTML += (data[17].horario)
    document.getElementById("loc").innerHTML += (data[17].localizacao)
    document.getElementById("comida").innerHTML += (data[17].tipoEspec)
