...
fetch("http://localhost:3000/restaurantes",).then((response) => response.json()).then((data) => {
    document.getElementById("nome").innerHTML += (data[9].nome)
    document.getElementById("horarios").innerHTML += (data[9].horario)
    document.getElementById("loc").innerHTML += (data[9].localizacao)
    document.getElementById("comida").innerHTML += (data[9].tipoEspec)
