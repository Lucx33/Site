...
fetch("http://localhost:3000/restaurantes",).then((response) => response.json()).then((data) => {
    document.getElementById("nome").innerHTML += (data[7].nome)
    document.getElementById("horarios").innerHTML += (data[7].horario)
    document.getElementById("loc").innerHTML += (data[7].localizacao)
    document.getElementById("comida").innerHTML += (data[7].tipoEspec)
...
function Avaliar(estrela) {
   ...
   const api_url = "http://localhost:3000/JaponesLeme"
