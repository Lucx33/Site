...
fetch("http://localhost:3000/restaurantes",).then((response) => response.json()).then((data) => {
    document.getElementById("nome").innerHTML += (data[18].nome)
    document.getElementById("horarios").innerHTML += (data[18].horario)
    document.getElementById("loc").innerHTML += (data[18].localizacao)
    document.getElementById("comida").innerHTML += (data[18].tipoEspec)
