...
fetch("http://localhost:3000/restaurantes",).then((response) => response.json()).then((data) => {
    document.getElementById("nome").innerHTML += (data[8].nome)
    document.getElementById("horarios").innerHTML += (data[8].horario)
    document.getElementById("loc").innerHTML += (data[8].localizacao)
    document.getElementById("comida").innerHTML += (data[8].tipoEspec)
